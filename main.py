...
put_text("This Virtual Check-Up will give result based on your choices and it doesn't guarantee the medical opinion.")
put_text('Kindly Note: This virtual health check-up is not for Athletes, Pregant Womens, Baby with less than 5 years and Old Person with more than 85 years.')
put_text('Under above cases, check-up report will be inappropriate.')
checkbox('User Terms', options=['I understand that Check-Up is for informational purpose.', 'In case of emergency, I will call the local emergency number and will consult the doctor.'])
...
rate = input_group('Some more info', [input("Please enter your Body Temperature in Celcius: ", name='temp', type=FLOAT, validate=check_temp),
                                      input('What is your Respiratory or Breath Rate?', name='resp', type=NUMBER, help_text="Respiratory Rate is the number of Breath you take per minute. You can calculate if you don't know."),
                                      input('How long can you hold your breath?', name='breathhold', type=NUMBER, help_text='Enter number of seconds you can hold your breath')])
if rate['resp']>20:
    points+=1
else:
    points=points
...
q1 = radio('How often you do Exercise/Work-outs?', options=['I do Little/No Exercise', 'I do Moderate/Regular Exercise',
...
if q3 == 'Yes':
    ...
    points=points
q4=radio("Do you have White spots on your nails?", options=['Yes', 'No'])
if q4 == 'Yes':
    points+= 1
else:
    points=points
q5=radio("Have you got new or strange rashes?", options=['Yes', 'No'])
if q5 == 'Yes':
    points+= 1
else:
    points=points
...
popup('COVID-19 Test', 'Thanks for answering the rapid fire questions. You now need to answer below questions for virtual COVID test.')
...
put_text(">> Based on your Basal Metabolic Rate, you need {} calories intake to maintain the current weight.".format(calories))
...
if cresult=="High":
	put_text(">> Well, it doesn't mean you have COVID-19 but it is highly recommended that you get your COVID-19 Checkup. Stay Home and get yourself quarantined for 14 days and monitor your symptoms regularly.")
elif cresult=="Moderate":
	put_text(">> You are somewhat exposed to COVID-19. It's better if you get yourself checked for COVID-19. Stay home and get yourself quarantined and wash hands regularly. Don't forget to monitor your symptoms on daily basis.")
elif cresult=="Low":
	put_text(">> Your infection risk is low. But it is recommended to stay home and avoid public contact. Wash Hands and Monitor your symptoms on regular basis.")
put_text("Fitness Score: ",points)
if points<2:
	put_text(">> Great, Your score is good. You are fit and live a healthy life. Make sure to continue your exercise and take the suggested protein and fats intake.")
elif points<6:
	put_text(">> You're somewhat fit, but if you continue to live like this, you will develop some of the serious symptoms in your old age.")
elif points<10:
	put_text(">> You're unhealthy and if live like this you will develop serious symptoms soon. Take the suggested proteins and fats and do some regular exercise to get fit.")
else:
	put_text(">> You're already unfit and you need to start exercising from now! Living the same life will lead you very serious issues in the future and your life expectancy will be reduced too. You need to wake up and start to work-out from now!")
